...
@section('content')
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header d-flex bg-white px-0">
                        <ul class="nav w-100 d-flex justify-content-around align-baseline m-0">
                            ...
                            <li class="nav-item col-lg-2 col-md-4 col-sm-6 col-12 center  border-start border-xs-none border-2 d-flex text-center  ">
                                <a class="page-link default-cursor center w-100 d-flex justify-content-center" href="#">
                                    <div class="w-75 pointer-cursor  card-header-items-hover services flex-column center">
                                        <svg viewBox="0 0 24 24" width="36px" height="36px" class="mt-3" fill="currentColor"
                                             data-v-554c8425="">
                            ...
                            <li class="nav-item col-lg-2 col-md-4 col-sm-6 col-12 center  border-start border-xs-none border-md-none border-2 d-flex text-center  ">
                                <a class="page-link  default-cursor d-flex justify-content-center w-100" href="#">
                                    <div class="w-75 rounded-3 pointer-cursor card-header-items-hover services flex-column center">
                                        <svg viewBox="0 0 24 24" width="36px" height="36px" class="mt-3" fill="currentColor"
                                             data-v-554c8425="">
                            ...
                            <li class="nav-item col-lg-2 col-md-4 col-sm-6 col-12 center  border-start border-xs-none border-2 border-lg-none d-flex  text-center ">
                                <a class="page-link center w-100 default-cursor d-flex justify-content-center" href="#">
                                    <div class="w-75  card-header-items-hover services flex-column pointer-cursor center">
                                        <svg viewBox="0 0 24 24" width="36px" height="36px" class="mt-3" fill="currentColor"
                                             data-v-554c8425="">
                            ...
                            <li class="nav-item col-lg-2 col-md-4 col-sm-6 col-12 center  border-start border-xs-none border-2 d-flex text-center">
                                <a class="page-link center w-100 default-cursor d-flex justify-content-center" href="#">
                                    <div class="w-75 pointer-cursor center services flex-column text-primary activedTitle">
                                        <svg viewBox="0 0 24 24" width="36px" height="36px" class="mt-3" fill="currentColor"
                                             data-v-554c8425="">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="d-flex dropdowns-place">

                            </div>
                            <div class="input-group d-flex justify-content-center">
                                <div class="col-lg-4 col-11 input-group-custom d-flex ms-2">
                                    <div class="col-5 mb-lg-0 mb-4 ms-lg-0">
                                        <input type="text" class=" form-control-lg form-control rounded-end-0" style="  border-top-right-radius: 0 !important;
  border-bottom-right-radius: 0 !important;"
                                               placeholder="From">
                                    </div>
                                    <span class="input-group-text pointer-cursor col-2 rounded-0 d-flex justify-content-center"
                                          style="height: 3rem">
                                <svg viewBox="0 0 24 24" width="2rem" fill="currentColor"><path
                                    ...
                                    <div class="col-5">
                                        <input type="text" class="form-control-lg form-control ps-4 rounded-start-0" style="border-bottom-left-radius: 0 !important;
  ...
  border-bottom-right-radius: 0 !important;"
                                    ...
                                    <label class="position-relative coming-input-label">
                                        <input type="text" class=" form-control-lg form-control rounded-start-0" style="  border-bottom-left-radius: 0 !important;
  border-top-left-radius: 0 !important;"
                                               placeholder="Coming" disabled>
                                    </label>
                                </div>
                                <div class="col-lg-2 col-11 ms-2 mb-lg-0 mb-4">
                                    <input type="text" class=" form-control-lg form-control" placeholder="1 passenger">
                                </div>
    ...
    <section class="mb-2">
        <div class="container">
            <div class="mb-5">
                ...
                <p class="text-muted mt-4 text-justify">Ipsum's outline or Lorem Ipsum is an experimental and nonsensical writing in the printing, page layout and graphic design industries. The graphic designer uses this text as an element of the composition to fill the page and provide the initial appearance and overall shape of the ordered design, to graphically indicate the type and size of the font and the appearance of the text.
                    Ipsum's outline or Lorem Ipsum is an experimental and nonsensical writing in the printing, page layout and graphic design industries. The graphic designer uses this text as an element of the composition to fill the page and provide the initial appearance and overall shape of the ordered design, to graphically indicate the type and size of the font and the appearance of the text.
                </p>
            </div>
            <div class="mb-5">
    ...
    <section class="w-100" style="background: #f8f9fa">
        <div class="container">
            <div class="accordion pb-5" id="accordion">
                ...
                <div class="accordion-item">
                    <div class="accordion-header">
                        <button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordionItemTwo">
                            <div class="me-4">
                                <svg viewBox="0 0 24 24" width="2rem" height="2rem" fill="#17A2B8" class="bg-primary-subtle rounded-circle"><path d="M14.442 16.905c0-1.427-.177-2.564-.531-3.411-.322-.77-.931-1.612-1.827-2.525l-.734-.726c-.787-.786-1.298-1.361-1.533-1.726a3.775 3.775 0 0 1-.646-2.126c0-1.005.249-1.776.747-2.312.498-.536 1.23-.804 2.197-.804.93 0 1.676.26 2.241.782.565.522.847 1.233.847 2.133h3.921c-.028-1.905-.68-3.413-1.953-4.524C15.898.556 14.212 0 12.115 0 9.951 0 8.266.548 7.06 1.645 5.853 2.74 5.25 4.275 5.25 6.248c0 1.752.814 3.476 2.442 5.17l1.996 1.954c.709.813 1.072 1.991 1.092 3.533h3.662Zm.273 5.027c0-.642-.199-1.159-.596-1.551-.397-.393-.936-.59-1.616-.59-.69 0-1.233.204-1.63.611-.397.407-.596.917-.596 1.53 0 .584.194 1.075.582 1.472.387.397.936.596 1.644.596.709 0 1.255-.199 1.637-.596.384-.397.575-.888.575-1.472Z"></path></svg>
                            </div>
                            <div class="">
                ...
                <div class="accordion-item">
                    <div class="accordion-header">
                        <button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordionItemThree">
                            <div class="me-4">
                                <svg viewBox="0 0 24 24" width="2rem" height="2rem" fill="#17A2B8" class="bg-primary-subtle rounded-circle"><path d="M14.442 16.905c0-1.427-.177-2.564-.531-3.411-.322-.77-.931-1.612-1.827-2.525l-.734-.726c-.787-.786-1.298-1.361-1.533-1.726a3.775 3.775 0 0 1-.646-2.126c0-1.005.249-1.776.747-2.312.498-.536 1.23-.804 2.197-.804.93 0 1.676.26 2.241.782.565.522.847 1.233.847 2.133h3.921c-.028-1.905-.68-3.413-1.953-4.524C15.898.556 14.212 0 12.115 0 9.951 0 8.266.548 7.06 1.645 5.853 2.74 5.25 4.275 5.25 6.248c0 1.752.814 3.476 2.442 5.17l1.996 1.954c.709.813 1.072 1.991 1.092 3.533h3.662Zm.273 5.027c0-.642-.199-1.159-.596-1.551-.397-.393-.936-.59-1.616-.59-.69 0-1.233.204-1.63.611-.397.407-.596.917-.596 1.53 0 .584.194 1.075.582 1.472.387.397.936.596 1.644.596.709 0 1.255-.199 1.637-.596.384-.397.575-.888.575-1.472Z"></path></svg>
                            </div>
                            <div class="">
                        ...
                        <div class="accordion-collapse collapse" data-bs-parent="#accordion" id="accordionItemThree">
                            <div class="accordion-body">
                                Ipsum's outline or Lorem Ipsum is an experimental and nonsensical writing in the printing, page layout and graphic design industries. The graphic designer uses this text as an element of the composition to fill the page and provide the initial appearance and overall shape of the ordered design, to graphically indicate the type and size of the font and the appearance of the text. Ipsum's outline or Lorem Ipsum is an experimental and nonsensical writing in the printing, page layout and graphic design industries. The graphic designer uses this text as an element of the composition to fill the page and provide the initial appearance and overall shape of the ordered design, to graphically indicate the type and size of the font and the appearance of the text.
                            </div>
                        </div>
                ...
                <div class="accordion-item">
                    <div class="accordion-header">
                        <button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordionItemFour">
                            <div class="me-4">
                                <svg viewBox="0 0 24 24" width="2rem" height="2rem" fill="#17A2B8" class="bg-primary-subtle rounded-circle"><path d="M14.442 16.905c0-1.427-.177-2.564-.531-3.411-.322-.77-.931-1.612-1.827-2.525l-.734-.726c-.787-.786-1.298-1.361-1.533-1.726a3.775 3.775 0 0 1-.646-2.126c0-1.005.249-1.776.747-2.312.498-.536 1.23-.804 2.197-.804.93 0 1.676.26 2.241.782.565.522.847 1.233.847 2.133h3.921c-.028-1.905-.68-3.413-1.953-4.524C15.898.556 14.212 0 12.115 0 9.951 0 8.266.548 7.06 1.645 5.853 2.74 5.25 4.275 5.25 6.248c0 1.752.814 3.476 2.442 5.17l1.996 1.954c.709.813 1.072 1.991 1.092 3.533h3.662Zm.273 5.027c0-.642-.199-1.159-.596-1.551-.397-.393-.936-.59-1.616-.59-.69 0-1.233.204-1.63.611-.397.407-.596.917-.596 1.53 0 .584.194 1.075.582 1.472.387.397.936.596 1.644.596.709 0 1.255-.199 1.637-.596.384-.397.575-.888.575-1.472Z"></path></svg>
                            </div>
                            <div class="">
